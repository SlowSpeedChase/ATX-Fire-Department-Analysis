...
def load_census_data():
    """Load census population and housing data"""
    print("\nLoading census data...")
...
def process_census_data(pop_df, housing_df):
    """
    ...
    housing_df['small_multifamily'] = housing_df['B25024_004E'].fillna(0) + housing_df['B25024_005E'].fillna(0)
    housing_df['medium_multifamily'] = housing_df['B25024_006E'].fillna(0) + housing_df['B25024_007E'].fillna(0)
    housing_df['large_multifamily'] = housing_df['B25024_008E'].fillna(0) + housing_df['B25024_009E'].fillna(0)
    housing_df['multifamily'] = housing_df['small_multifamily'] + housing_df['medium_multifamily'] + housing_df['large_multifamily']
    ...
    census = pop_df[['GEOID', 'population']].merge(
        housing_df[['GEOID', 'total_units', 'single_family', 'multifamily', 
                    'small_multifamily', 'medium_multifamily', 'large_multifamily', 'mobile_other']],
        on='GEOID',
        how='outer'
    )
...
def allocate_demographics(crosswalk, census_df, response_areas_gdf, ra_id_col):
    ...
    numeric_cols = ['population', 'total_units', 'single_family', 'multifamily',
                    'small_multifamily', 'medium_multifamily', 'large_multifamily', 'mobile_other']
...
def main():
    ...
    pop_df, housing_df = load_census_data()
    
    # Process census data
    census = process_census_data(pop_df, housing_df)
